...
const breakColdAnalyticsSchema = new mongoose.Schema({
    ...
    platform: { 
        ...
        validate: {
            validator: function(v) {
                return v.toLowerCase() === 'breakcold';
            },
    ...
    timestamps: true,
    collection: 'breakcoldanalytics'
});

// Remove any existing indexes
mongoose.connection.collections['breakcoldanalytics']?.dropIndexes();

export default mongoose.model('BreakColdAnalytics', breakColdAnalyticsSchema);
